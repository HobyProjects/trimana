...
namespace trimana_core
{
    ...
    {
    public:
        event_keyboard_key_press(int32_t key_code) : m_key_code(key_code) {}
        ...
        int32_t get_key_code() const { return m_key_code; }

    private:
        int32_t m_key_code{NULL};
    };

    class event_keyboard_key_release : public events
    {
    public:
        event_keyboard_key_release(int32_t key_code) : m_key_code(key_code) {}
    ...
    {
    public:
        event_keyboard_key_hold(int32_t key_code) : m_key_code(key_code) {}
